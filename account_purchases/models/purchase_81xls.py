...
class ExcelReport(object):
    ...
    def get_content(self):
        ...
        f2_dec = workbook.add_format({'font_size': 9, 'align': 'vcenter', 'bold': False, 'num_format': '#,##0.00'})
        ...
        f7 = workbook.add_format({'font_size': 10, 'align': 'vcenter', 'bold': True, 'top': True, 'bottom': True, 'num_format': '#,##0.00'})
        ...
        sheet.write(6, 12, '', f3)
        sheet.write(7, 12, 'VALOR', f4)
        sheet.write(8, 12, 'DE LAS', f4)
        sheet.write(9, 12, 'ADQUISIONES', f4)
        sheet.write(10, 12, 'NO', f4)
        sheet.write(11, 12, 'GRAVADAS', f5)

        sheet.write(6, 13, '', f3)
        sheet.write(7, 13, '', f4)
        sheet.write(8, 13, 'IMPORTE', f4)
        sheet.write(9, 13, 'TOTAL', f4)
        sheet.write(10, 13, '', f4)
        sheet.write(11, 13, '', f5)

        sheet.merge_range('O7:P7', 'CONSTANCIA DE DEPOSITO', f3)
        sheet.merge_range('O8:P8', 'DE DETRACCION', f5)
        sheet.merge_range('O9:P9', '', f5)
        sheet.write(9, 14, '', f4)
        sheet.write(10, 14, 'NUMERO', f4)
        sheet.write(11, 14, '', f5)

        sheet.write(9, 15, 'FECHA', f4)
        sheet.write(10, 15, 'DE', f4)
        sheet.write(11, 15, 'EMISION', f5)

        sheet.write(6, 16, '', f3)
        sheet.write(7, 16, '', f4)
        sheet.write(8, 16, 'TIPO', f4)
        sheet.write(9, 16, 'DE', f4)
        sheet.write(10, 16, 'CAMBIO', f4)
        sheet.write(11, 16, '', f5)

        sheet.merge_range('R7:U7', 'REFERENCIA DEL COMPROBANTE DE PAGO', f3)
        sheet.merge_range('R8:U8', 'O DOCUMENTO ORIGINAL', f5)
        sheet.merge_range('R9:U9', 'QUE SE MODIFICA', f5)
        sheet.write(9, 17, '', f4)
        sheet.write(10, 17, 'FECHA', f4)
        sheet.write(11, 17, '', f5)

        sheet.write(9, 18, '', f4)
        sheet.write(10, 18, 'TIPO', f4)
        sheet.write(11, 18, '', f5)

        sheet.write(9, 19, '', f4)
        sheet.write(10, 19, 'SERIE', f4)
        sheet.write(11, 19, '', f5)

        sheet.write(9, 20, '', f4)
        sheet.write(10, 20, 'NUMERO', f4)
        ...
        for purchases in self.data:
            ...
            sheet.write(row, col + 10, purchases['BASE AG-VG'], f2_dec)
            sheet.write(row, col + 11, purchases['IGV AG-VG'], f2_dec)
            sheet.write(row, col + 12, purchases['INAFECTO'], f2_dec)
            sheet.write(row, col + 13, purchases['TOTAL'], f2_dec)
            sheet.write(row, col + 14, purchases['CONSTANCIA'], f2)
            sheet.write(row, col + 15, purchases['FECHA CONSTANCIA'], f2_date)
            sheet.write(row, col + 16, purchases['TIPO DE CAMBIO'], f6)
            sheet.write(row, col + 17, purchases['FECHA REV'], f2_date)
            sheet.write(row, col + 18, purchases['TIPO REV'], f2)
            sheet.write(row, col + 19, purchases['SERIE REV'], f2)
            sheet.write(row, col + 20, purchases['NUMERO REV'], f2)

            if purchases['BASE AG-VG']:
                if -0.05 < purchases['IGV AG-VG']/purchases['BASE AG-VG'] - 0.18 < 0.05:
                    sheet.write(row, col + 21, '18%', f6)
                elif -0.05 < purchases['IGV AG-VG']/purchases['BASE AG-VG'] - 0.1 < 0.05:
                    sheet.write(row, col + 21, '10%', f6)
                else:
                    sheet.write(row, col + 21, 'IGV DESCONOCIDO', f6)
            else:
                sheet.write(row, col + 21, 'EXO', f6)

        contador = len(self.data)
        print("fffffffffffffffffffffffffffffffff",contador,flush=True)
        rowen = 13 + contador
