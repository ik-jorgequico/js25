...
class ExcelReport(object):
	...
	def get_content(self):
		...
		sheet.set_column('W:W', 4)
		sheet.set_column('X:X', 5)
		sheet.set_column('Y:Y', 9)
		...
		sheet.write(6, 17, '', f3)
		sheet.write(7, 17, '', f4)
		sheet.write(8, 17, 'IMPORTE', f4)
		sheet.write(9, 17, 'TOTAL', f4)
		sheet.write(10, 17, '', f4)
		sheet.write(11, 17, '', f5)

		sheet.merge_range('S7:T7', 'CONSTANCIA DE DEPOSITO', f3)
		sheet.merge_range('S8:T8', 'DE DETRACCION', f5)
		sheet.merge_range('S9:T9', '', f5)
		sheet.write(9, 18, '', f4)
		sheet.write(10, 18, 'NUMERO', f4)
		sheet.write(11, 18, '', f5)

		sheet.write(9, 19, 'FECHA', f4)
		sheet.write(10, 19, 'DE', f4)
		sheet.write(11, 19, 'EMISION', f5)

		sheet.write(6, 20, '', f3)
		sheet.write(7, 20, '', f4)
		sheet.write(8, 20, 'TIPO', f4)
		sheet.write(9, 20, 'DE', f4)
		sheet.write(10, 20, 'CAMBIO', f4)
		sheet.write(11, 20, '', f5)

		sheet.merge_range('V7:Y7', 'REFERENCIA DEL COMPROBANTE DE PAGO', f3)
		sheet.merge_range('V8:Y8', 'O DOCUMENTO ORIGINAL', f5)
		sheet.merge_range('V9:Y9', 'QUE SE MODIFICA', f5)
		sheet.write(9, 21, '', f4)
		sheet.write(10, 21, 'FECHA', f4)
		sheet.write(11, 21, '', f5)

		sheet.write(9, 22, '', f4)
		sheet.write(10, 22, 'TIPO', f4)
		sheet.write(11, 22, '', f5)

		sheet.write(9, 23, '', f4)
		sheet.write(10, 23, 'SERIE', f4)
		sheet.write(11, 23, '', f5)

		sheet.write(9, 24, '', f4)
		sheet.write(10, 24, 'NUMERO', f4)
		...
		for purchases in self.data:
			...
			sheet.write(row, col + 17, float(purchases['TOTAL']), f2_dec)
			sheet.write(row, col + 18, purchases['CONSTANCIA'], f2)
			sheet.write(row, col + 19, purchases['FECHA CONSTANCIA'], f2_date)
			sheet.write(row, col + 20, float(purchases['TIPO DE CAMBIO']), f6)
			sheet.write(row, col + 21, purchases['FECHA REV'], f2_date)
			sheet.write(row, col + 22, purchases['TIPO REV'], f2)
			sheet.write(row, col + 23, purchases['SERIE REV'], f2)
			sheet.write(row, col + 24, purchases['NUMERO REV'], f2)
			sheet.write(row, col + 25, purchases['PERCENT IGV'], f2)
