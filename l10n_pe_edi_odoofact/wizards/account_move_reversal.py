...
class AccountMoveReversal(models.TransientModel):
    ...
    def _prepare_default_reversal(self, move):
        ...
        _logger.warning("11111111------%s---" %(res))
        document_type = self.env["l10n_latam.document.type"].search(
            [("code","=",'07'),('doc_code_prefix','=',move.l10n_latam_document_type_id.doc_code_prefix)], limit=1
        )
        res.update(
            {
                ...
                request_id = self.env["l10n_pe_edi.request"].create(
                    {
                        ...
                        "l10n_pe_edi_document_type": move.l10n_latam_document_type_id and move.l10n_latam_document_type_id.code or False,
                        "l10n_pe_edi_document_type_id": document_type and document_type.id or False,
