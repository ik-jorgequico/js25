...
class HrUtilitiesMacro(object):
    ...
    def get_content(self):
        ...
        sheet = wb.add_worksheet('Utilidades Macro') # crear la hoja trabajador
        ...
        """
            PRINT COLUMNS
        """
        sheet.autofilter('A7:J8') #crear filtrado de la columna A10 - Q10
        ...
        sheet.merge_range(row - 1,8,row,8,"DOCUMENTO DE IDENTIDAD",column_content_table_format)
        ...
        for i,dict in enumerate(self.data):
            ...
            sheet.write(i + row + 1,8,dict["dni"],style_content_table_format)
